...
public class SpecializationFormController {
    ...
    @GetMapping(path = "/specialization/add")
    ...
    @GetMapping(path = "/specialization/edit")
    ...
    @PostMapping(path = "/specialization/edit")
    ...
    @GetMapping(path = "/specialization/search")
    String showSearchSpecializationForm() {
        return "specialization/search";
    }

    @GetMapping(path = "/specialization/search", params = "name")
