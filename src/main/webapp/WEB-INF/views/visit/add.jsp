...
<div class="container" id="add-edit-search-container">
        ...
        <div class="sub-container">
            <form:form method="post" modelAttribute="visit">
                ...
                <div class="form-group">
                    <label for="specialization.id"><p>Patient:</p></label>
                    <form:select path="patient.id" items="${patients}" itemLabel="fullName" itemValue="id"/>
                    <form:errors path="specialization" cssClass="error"/>
                </div>
                <div class="form-group">
                    <label for="specialization.id"><p>Treatment:</p></label>
                    <form:select path="specialization.id" items="${treatments}" itemLabel="name" itemValue="id"/>
                    <form:errors path="specialization" cssClass="error"/>
                </div>
                <div class="form-group">
                    <label for="specialization.id"><p>Specialist:</p></label>
                    <form:select path="specialist.id" items="${specialists}" itemLabel="fullName" itemValue="id"/>
                    <form:errors path="specialization" cssClass="error"/>
                </div>
                <input type="hidden" path="id"/>
                <input type="submit" value="Add visit" class="button" class="button" id="yellow-button">
            </form:form>
        </div>
        <div class="sub-container">
