...
insert into specialists(id, specialization_id, dateOfBirth, firstName, lastName, pesel) values (1, 1, '1950.05.05', 'Jan', 'Frojd', '50050550550'), (2, 2, '1970.08.08', 'Anna', 'Terapia', '70080850881');